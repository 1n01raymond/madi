...
Phase 1 is complete, and this tracker is retained as the historical capability
ledger for that exit. Current implementation state, prioritized work,
dependencies, and evidence debt now live in the [Phase 2 tracker](PHASE_2.md).
Later evidence must not be backfilled as if it had been required for the Phase 1
decision.
