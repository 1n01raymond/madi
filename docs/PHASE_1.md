...
| Review interaction | Orthographic orbit/pan/zoom/fit, synchronized canvas/tree selection, and hide/isolate/show-all share one occurrence state; selection and visibility update without rebuilding GPU resources | Passed by camera/visibility unit tests and browser interaction review |
...
- Section interaction; hierarchy search and properties remain pending.
